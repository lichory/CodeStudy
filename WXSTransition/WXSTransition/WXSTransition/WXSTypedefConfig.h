...
typedef NS_ENUM(NSInteger,WXSTransitionAnimationType){
    ...
    WXSTransitionAnimationTypeSysRevealFromBottom,//揭开Reveal
    ...
    WXSTransitionAnimationTypeSysMoveInFromBottom,//覆盖MoveIn
    ...
    WXSTransitionAnimationTypeFragmentShowFromRight,//碎片
