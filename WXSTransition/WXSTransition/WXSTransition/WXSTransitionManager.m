...
/* 动画 结束的代理 不过 这个代理是 CAAnimationDelegate 的代理 **/
...
/*********** 系统转场 和 回场动画  ************************/
-(void)sysTransitionAnimationWithType:(WXSTransitionAnimationType)type
...
-(void)backSysTransitionAnimationWithType:(WXSTransitionAnimationType)type
                                  context:(id<UIViewControllerContextTransitioning>)transitionContext {
